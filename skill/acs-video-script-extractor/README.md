...
它不是简单把 Whisper 跑一遍，而是把**媒体预检、双模型转写、差异定位、字幕画面复核、人工校对、忠实整理、最终验收**串成一条可追溯流程。

> 原始转写负责保留“模型听到了什么”，校对稿负责说明“最终确认是什么”，忠实整理稿负责把原话清理成可继续使用的文案。
...
- `文案-忠实整理版.md`：只清理口头农顿、无意义重复和拍摄口令，不新增观点；
...
全程离线，先做双模型转写，再校对字幕画面，最后给我完整逐字稿、忠实整理文案和待确认疑点。
```
