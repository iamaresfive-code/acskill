...
def fixture(run:Path):
    ...
    # ---- Report Layer 完整 fixture（公开网页证据 + 资产评分 + 概念绑定 + 分析五层）----
    mf=['evidence_id','entity_id','entity_name','field','source_url','source_title','source_grade','source_owner','platform','domain','region_relevant','recency_months','content_type','access_status','url_http_status','url_content_hash','observed_at','concept','binding_type','strength','basis','source_type','notes']
    wcsv(run/'report_research_manifest.csv',mf,[
        {'evidence_id':'RR0001','entity_id':'I1','entity_name':'甲公考','field':'official_website','source_url':'https://jia.example','source_title':'甲公考官网','source_grade':'A2','source_owner':'owned','platform':'official-site','domain':'jia.example','region_relevant':'true','recency_months':'2','content_type':'homepage','access_status':'found','url_http_status':'200','url_content_hash':'deadbeef00000001','observed_at':'2026-09-10','concept':'','binding_type':'','strength':'','basis':'','source_type':'','notes':'合成 fixture'},
        {'evidence_id':'RR0002','entity_id':'I2','entity_name':'全国乙教育','field':'official_website','source_url':'https://yi.example','source_title':'全国乙教育官网','source_grade':'A2','source_owner':'owned','platform':'official-site','domain':'yi.example','region_relevant':'false','recency_months':'3','content_type':'homepage','access_status':'found','url_http_status':'200','url_content_hash':'deadbeef00000002','observed_at':'2026-09-10','concept':'','binding_type':'','strength':'','basis':'','source_type':'','notes':'合成 fixture'},
        {'evidence_id':'RR0003','entity_id':'P1','entity_name':'乙老师','field':'official_social_account','source_url':'https://space.example/p1','source_title':'乙老师主页','source_grade':'A2','source_owner':'owned','platform':'bilibili','domain':'space.example','region_relevant':'true','recency_months':'1','content_type':'profile','access_status':'found','url_http_status':'200','url_content_hash':'deadbeef00000003','observed_at':'2026-09-10','concept':'','binding_type':'','strength':'','basis':'','source_type':'','notes':'合成 fixture'},
        {'evidence_id':'RR0004','entity_id':'X1','entity_name':'新星老师','field':'official_social_account','source_url':'https://space.example/x1','source_title':'新星老师主页','source_grade':'A2','source_owner':'owned','platform':'bilibili','domain':'space.example','region_relevant':'unknown','recency_months':'4','content_type':'profile','access_status':'found','url_http_status':'200','url_content_hash':'deadbeef00000004','observed_at':'2026-09-10','concept':'','binding_type':'','strength':'','basis':'','source_type':'','notes':'合成 fixture'}])
    af=['entity_id','canonical_name','entity_clarity','regional_semantic_density','open_web_assets','external_authority','content_depth_freshness','data_tool_assets','platform_coverage','evidence_refs','evidence_date','confidence','unknown_fields','notes']
    wcsv(run/'asset_inputs.csv',af,[
        {'entity_id':'I1','canonical_name':'甲公考','entity_clarity':25,'regional_semantic_density':20,'open_web_assets':15,'external_authority':15,'content_depth_freshness':10,'data_tool_assets':10,'platform_coverage':5,'evidence_refs':'RR0001','evidence_date':'2026-09-10','confidence':'high','unknown_fields':'','notes':'合成 fixture'},
        {'entity_id':'I2','canonical_name':'全国乙教育','entity_clarity':25,'regional_semantic_density':15,'open_web_assets':12,'external_authority':15,'content_depth_freshness':10,'data_tool_assets':6,'platform_coverage':5,'evidence_refs':'RR0002','evidence_date':'2026-09-10','confidence':'high','unknown_fields':'','notes':'合成 fixture'},
        {'entity_id':'P1','canonical_name':'乙老师','entity_clarity':25,'regional_semantic_density':15,'open_web_assets':8,'external_authority':4,'content_depth_freshness':10,'data_tool_assets':6,'platform_coverage':5,'evidence_refs':'RR0003','evidence_date':'2026-09-10','confidence':'medium','unknown_fields':'','notes':'合成 fixture'},
        {'entity_id':'X1','canonical_name':'新星老师','entity_clarity':18,'regional_semantic_density':'unknown','open_web_assets':4,'external_authority':'unknown','content_depth_freshness':7,'data_tool_assets':6,'platform_coverage':5,'evidence_refs':'RR0004','evidence_date':'2026-09-10','confidence':'medium','unknown_fields':'regional_semantic_density|external_authority','notes':'合成 fixture：两项缺证据记 unknown'}])
    assets.score(run)
    cf=['concept','entity_id','canonical_name','strength','binding_type','basis','source_url','source_type','observed_at','evidence_ids','notes']
    wcsv(run/'concept_ownership.csv',cf,[
        {'concept':'示例省面试','entity_id':'I1','canonical_name':'甲公考','strength':'9','binding_type':'owned-declaration','basis':'官网课程页明确标注本地面试课程','source_url':'https://jia.example/course','source_type':'official-site','observed_at':'2026-09-10','evidence_ids':'RR0001','notes':'合成 fixture'},
        {'concept':'申论','entity_id':'X1','canonical_name':'新星老师','strength':'7','binding_type':'high-frequency-public-binding','basis':'多个独立公开页面均以其申论内容为主题','source_url':'https://space.example/x1','source_type':'official-account','observed_at':'2026-09-10','evidence_ids':'RR0004','notes':'合成 fixture'}])
    (run/'analysis.json').write_text(json.dumps({'schema_version':'2.2','generated_from':{'ai_metrics.csv':12},'executive_summary':['合成 fixture：示例省确认 3 个正式主体，另有 1 个 AI-emergent 主体。'],'facts':[{'statement':'示例省共确认 3 个正式主体。','basis':'market_universe.csv'}],'metrics':[{'metric':'nomination_rate','statement':'甲公考 institution 通道提名率 1.0。','basis':'ai_metrics.csv'}],'proxies':[{'statement':'Asset Readiness 为公开资产代理指标。','basis':'asset_scores.csv'}],'inferences':[{'statement':'资产强度与可见度不一定同步。','basis':'asset_scores.csv × ai_metrics.csv'}],'recommendations':[{'statement':'优先建设主体×概念绑定页。','basis':'concept_ownership.csv'}],'diagnoses':[{'name':'甲公考','market_role':'local-core','ai_visibility':'institution 4/4（提名率 1.0）','strongest_asset':'实体清晰度 25/25','largest_gap':'缺少第三方权威引用','recommendation':'补充本地考试主题可引用页面'}],'strategy':['合成策略：以主体×概念绑定页优先，避免用资产分替代可见度诊断。'],'plan_90_days':['0–30 天：实体与概念页；31–60 天：可引用资产；61–90 天：第三方证据与复测。'],'limitations':['合成 fixture 限制说明：单引擎、外部检索增强、程序性隔离。']},ensure_ascii=False,indent=2),encoding='utf-8')
    met.compute(run);rob.compute(run);modeler.build(run)
